...
protected:
	...
	//Matricies
	glm::mat4 projectionMatrix, transformationMatrix, rotationMatrix, 
		scaleMatrix, rotationXMatrix, rotationYMatrix, rotationZMatrix, 
		modelMatrix, translationMatrix, viewMat;
	...
	//Vectors
	glm::vec3 pos, posI, vel, acc, rot, netForce;
	GLsizei numVertices; 
	bool isLight;
};
